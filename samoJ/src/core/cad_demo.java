...
public class cad_demo {
	...
	public static double[] mouse = new double[2]; //coords of mouse when mouse_plan_motion  
	public static double[] cursor_coords = new double[2]; //latest coords of cursor
	public static double[] point_1_coords = new double[2]; //coords of point 1 for draw objects or make actions with them
